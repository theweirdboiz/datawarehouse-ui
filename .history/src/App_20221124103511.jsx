      ...
      <div className="flex justify-between">
        <section className="content max-w-3xl">
          ...
          <div className="content__detail mb-20">
            ...
            >
              <SwiperSlide>
                <div className="shadow-2xl content__detail-item p-5 rounded-xl ">
                  <div className="speed flex flex-col">
              ...
              <SwiperSlide>
                <div className="shadow-2xl content__detail-item p-5  bg-backgroundSecondary rounded-xl">
                  <div className="speed flex flex-col">
                    <h4 className="text-[#888] text-center">Hiện tại</h4>
                    <div className="flex items-center justify-between">
                      <img
              ...
              <SwiperSlide>
                <div className="shadow-2xl content__detail-item p-5  bg-backgroundSecondary shadow-lg rounded-xl">
                  <div className="speed flex flex-col">
                    <h4 className="text-[#888] text-center">Hiện tại</h4>
                    <div className="flex items-center justify-between">
                      <img
