  ...
  return (
    <div className="p-5 mx-auto max-w-7xl">
      <div className="flex justify-between">
        <section className="content max-w-3xl bg-[url('https://i.pinimg.com/564x/58/e2/8d/58e28d0cfd65a2c362f3496aedf258ca.jpg')]">
          ...
          <div className="content__detail mb-20">
            ...
            <div>
              <div className="content__detail-box grid grid-cols-3 gap-4 mt-6">
                <div className="content__detail-item p-5 flex items-center gap-x-6 bg-backgroundSecondary shadow-xl rounded-xl">
                ...
                <div className="content__detail-item p-5 flex items-center gap-x-6 bg-backgroundSecondary shadow-xl rounded-xl">
                  ...
                  <div className="speed flex flex-col">
                    <h4 className="text-[#888]">Độ ẩm</h4>
                ...
                <div className="content__detail-item p-5 flex items-center gap-x-6 bg-backgroundSecondary shadow-xl rounded-xl">
                  ...
                  <div className="speed flex flex-col">
                    <h4 className="text-[#888]">Tầm nhìn</h4>
                ...
                <div className="content__detail-item p-5 flex items-center gap-x-6 bg-backgroundSecondary shadow-xl rounded-xl">
                  ...
                  <div className="speed flex flex-col">
                    <h4 className="text-[#888]">Điểm ngưng</h4>
                    <span className="text-[24px] font-semibold">12km/h</span>
                  </div>
                  <h6 className="text-[#888]">
                    <FontAwesomeIcon className="" icon={faCaretDown} />
                ...
                <div className="content__detail-item p-5 flex items-center gap-x-6 bg-backgroundSecondary shadow-xl rounded-xl">
                  ...
                  <div className="speed flex flex-col">
                    <h4 className="text-[#888]">Chỉ số UV</h4>
                    <span className="text-[24px] font-semibold">12km/h</span>
                  </div>
                  <h6 className="text-[#888]">
                    <FontAwesomeIcon className="" icon={faCaretDown} />
          ...
          <div className="content__detail mb-20">
            ...
            >
              <SwiperSlide>
                <div className="content__detail-item p-5  bg-backgroundSecondary shadow-xl rounded-xl">
                  <div className="speed flex flex-col">
