      ...
      <div className="">
        <section className="content">
          ...
          <div className="content__detail">
            ...
            <div>
              <div className="content__detail-box grid grid-cols-2 gap-4">
                <div className="content__detail-item p-5 flex items-center gap-x-6 bg-slate-100 rounded-lg">
                  <i></i>
                ...
                <div className="content__detail-item p-5">
                  <i></i>
                  <div className="speed">
                    Wind speed
                    <span>12km/h</span>
