          ...
          <div className="bg-slate-600 p-5 h-full rounded-xl">
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex items-center  max-w-[160px]">
                <FontAwesomeIcon className="mr-autoflex flex-1" icon={faSun} />
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex items-center  max-w-[160px]">
                <FontAwesomeIcon className="mr-auto" icon={faDroplet} />
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex items-center  max-w-[160px]">
                <FontAwesomeIcon className="mr-auto" icon={faEyeSlash} />
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex items-center  max-w-[160px]">
                <FontAwesomeIcon className="mr-auto" icon={faWind} />
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex items-center  max-w-[160px]">
                <FontAwesomeIcon className="mr-auto" icon={faUmbrellaBeach} />
