        ...
        <section className="content__right text-white min-w-[320px]">
          <div className="bg-slate-600 p-5 h-full rounded-xl">
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex gap-x-4 max-w-[100px]">
                <FontAwesomeIcon className="w-[50%]" icon={faSun} />
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex gap-x-4 max-w-[100px]">
                <FontAwesomeIcon className="w-[50%]" icon={faDroplet} />
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex gap-x-4 max-w-[100px]">
                <FontAwesomeIcon className="w-[50%]" icon={faEyeSlash} />
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex gap-x-4 max-w-[100px]">
                <FontAwesomeIcon className="w-[50%]" icon={faWind} />
            ...
            <div className="mt-2 pb-2 flex justify-between items-center border-b-[1px] border-borderGray text-sm">
              <h2 className="flex gap-x-4 max-w-[100px]">
                <FontAwesomeIcon className="w-[50%]" icon={faUmbrellaBeach} />
